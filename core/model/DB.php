...
class DB {
	 ...
	 * @param SS_Int $errorLevel The level of error reporting to enable for the query
	 * @return SS_Query
	 */
	 ...
	 * @return SS_Boolean Returns true if successful
	 */
	 ...
	 * @param SS_Boolean $hasAutoIncPK A flag indicating that the primary key on this table is an autoincrement type
	 ...
	 * @param string|SS_Boolean $spec The specification of the index. See requireTable() for more information.
	 */
